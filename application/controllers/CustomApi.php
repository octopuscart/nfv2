...
class CustomApi extends REST_Controller {
    ...
    function jacketCustomization_get() {
        ...
        $shirtCustomization = array(
            ...
            'Back Vent' => $this->Product_model->getChildren(53),
        ...
        $selectelements = array(
            ...
            'Handstitching' => "No",
            'Front Style' => "2 Buttons",
            'Sleeve Buttons' => '4 Flat Buttons',
        ...
        $mainnavigation = array(
            ...
            'Lapel Button Hole' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Handstitching' => array("choice" => "", "col" => "4", "prenext" => 1),
            ...
            'Back Vent' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Shoulder Padding' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Breast Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
    ...
    function overcoatCustomization_get() {
        ...
        $mainnavigation = array(
            'Body Fit' => array("choice" => "", "col" => "4", "prenext" => 0),
            'Category' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Lapel Style & Width' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol2", "prenext" => 1),
            'Lapel Button Hole' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Front Style' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol", "prenext" => 1),
            'Sleeve Buttons' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol", "prenext" => 1),
            'Shoulder Epaulettes' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Sleeve Epaulettes' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Breast Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Lower Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Inside Zipper Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Lining Type' => array("choice" => "", "col" => "4", "prenext" => 1),
            "Lining Style" => array("choice" => "multi", "col" => "4", "lablestyle" => "", "view" => "multi", "prenext" => 1),
            "Contrast Button Thread" => array("choice" => "multi", "col" => "4", "prenext" => 1, "view" => "selection",),
            "Contrast Button Hole On Lapel" => array("choice" => "multi", "col" => "4", "prenext" => 1, "view" => "selection",),
    ...
    function pantCustomization_get() {
        ...
        $shirtCustomization = array(
            ...
            'Number of Back Pocket' => $this->Product_model->getChildren(8),
        );
        $selectelements = array(
            'Body Fit' => "Medium Fit",
            ...
            'Number of Back Pocket' => "2 Pockets with Buttons (Standard)",
        );
        $mainnavigation = array(
            'Body Fit' => array("choice" => "", "col" => "4", "prenext" => 0),
            'Number of Pleat' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol2", "prenext" => 1),
            'Waistband' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Suspender Buttons on Inner waistband' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Cuff' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Zipper - Front Fly' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Front Pocket Style' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Number of Back Pocket' => array("choice" => "", "col" => "4", "prenext" => 2),
        );
    ...
    function waistcoatCustomization_get() {
        ...
        $mainnavigation = array(
            ...
            'Front Edge' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Back Fabric' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multi", "prenext" => 1),
            'Back Style' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Breast Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Lower Pocket' => array("choice" => "", "col" => "4", "prenext" => 2),
        );
    ...
    function c3PieceSuitCustomization_get() {
        ...
        $mainnavigation = array(
            ...
            'Waistcoat Lapel Button Hole' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Waistcoat Handstitching' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Waistcoat Front Style' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol2", "prenext" => 1),
            'Waistcoat Front Edge' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Waistcoat Back Fabric' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multi", "prenext" => 1),
            'Waistcoat Back Style' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Waistcoat Breast Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Waistcoat Lower Pocket' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Number of Pleat' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol2", "prenext" => 1),
            'Waistband' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Suspender Buttons on Inner waistband' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Cuff' => array("choice" => "", "col" => "4", "prenext" => 1),
    ...
    function tuxedoPantCustomization_get() {
        ...
        $mainnavigation = array(
            'Body Fit' => array("choice" => "", "col" => "4", "prenext" => 0),
            'Number of Pleat' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol2", "prenext" => 1),
            'Ribbon on Side Seam' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Waistband' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Suspender Buttons on Inner waistband' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Cuff' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Zipper - Front Fly' => array("choice" => "", "col" => "4", "prenext" => 1),
    ...
    function tuxedoSuitCustomization_get() {
        ...
        $mainnavigation = array(
            'Body Fit' => array("choice" => "", "col" => "4", "prenext" => 0),
            'Lapel Style & Width' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol2", "prenext" => 1),
            'Lapel Facing' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Front Style' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol", "prenext" => 1),
            'Back Vent' => array("choice" => "", "col" => "4", "prenext" => 1),
            'Sleeve Buttons' => array("choice" => "", "col" => "4", "lablestyle" => "", "view" => "multicol", "prenext" => 1),
            'Shoulder Padding' => array("choice" => "", "col" => "4", "prenext" => 1),
