    ...
    <div id="content"  > 
        ...
        <section class="error-page text-center pad-t-b-130">
            <div class="container "> 
                ...
                <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token= <?php  echo $token;?>" class="btn btn-default ">RETRY PAYPAL <i class="fa fa-arrow-right"></i></a>
            </div>
        </section>
    </div>
    <!-- End Content --> 
