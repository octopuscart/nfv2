                                                                ...
                                                                <tr>
                                                                    <td colspan="4" class="text_right">
                                                                        <div class="proceed-button pull-left " >
                                                                            <a href=" <?php echo site_url("CartGuest/checkShipping"); ?>" class="btn btn-default checkout_button_pre " ><i class="fa fa-arrow-left"></i> View Shipping Address</a>
                                                                        </div>
                                                            ...
                                                            <tbody id="quantity-holder">
                                                                <tr>
                                                                    <td colspan="4" class="text_right">
                                                                        ...
                                                                        <div class="proceed-button pull-right ">
                                                                            <button type="submit" name="place_order" class="btn btn-default checkout_button_next "  value="Bank Transfer">
